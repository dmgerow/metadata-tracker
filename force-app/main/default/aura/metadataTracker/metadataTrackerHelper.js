({
    ...
    doDescribeSingle: function (component, data) {
        ...
        action.setCallback(this, function (response) {
            ...
            if (state === "SUCCESS") {
                ...
                component.set('v.filteredFiles', reponseObject.files.slice(0, component.get("v.maxResultLength")));
            } else if (state === "ERROR") {
    ...
    doListSingle: function (component, data) {
        ...
        for (var i = 0; i < reponseObject.length; i++) {
            ...
            reponseObject[i]["externalKey"] = reponseObject[i].type + "|" + reponseObject[i].fullName;
        ...
        component.set('v.filteredFiles', reponseObject.slice(0, component.get("v.maxResultLength")));
        this.doSetSpinner(component, false);
    },
    doUpdateTrackedMetadata: function (component, eventRow, type) {
        ...
        action.setCallback(this, function (response) {
            ...
            if (state === "SUCCESS") {
                switch (type) {
                    case 'track':
                        this.doSetButtons(eventRow, component, false, false, false, 'utility:check');
                        break;
                    case 'untrack':
                        this.doSetButtons(eventRow, component, false, true, false, 'utility:add');
                        break;
                    case 'destroy':
                        this.doSetButtons(eventRow, component, false, false, true, 'utility:add');
                        break;
                }
            } else if (state === "ERROR") {
                var errors = response.getError();
    ...
    doSearch: function (component) {
        ...
        component.set('v.filteredFiles', filteredRows.slice(0, component.get("v.maxResultLength")));
        this.doSetSpinner(component, false);
    },
    doSetButtons: function (eventRow, component, trackDisabled, untrackDisabled, destroyDisabled, trackIcon) {
